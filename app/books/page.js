  ...
  return (
    <main dir={isFa ? 'rtl' : 'ltr'} className="min-h-screen bg-white text-black font-sans pb-12">
      ...
      <div className="max-w-6xl mx-auto px-4 mt-6">
        {/* ۱. کتاب‌های تدریس شده (کامپوننت قبلی بدون دستکاری) */}
        {activeTab === 'taught' && (
          <BooksSection lang={lang} />
        )}

        {/* ۲. خلاصه فصل‌های کتاب شامل زیربخش‌های پایه هفتم تا دوازدهم */}
        {activeTab === 'summaries' && (
            ...
            <div className="text-center py-12 bg-gray-50 rounded-2xl border border-dashed border-gray-300">
              {selectedGrade ? (
                ...
                <p className="text-gray-500 text-sm md:text-base font-medium">
                  {isFa 
                    ? 'لطفاً پایه تحصیلی (هفتم تا دوازدهم) را از کادر بالا انتخاب کنید.' 
                    : 'Please select a grade (Grade 7-12) from above.'}
                </p>
              )}
            </div>
          </div>
