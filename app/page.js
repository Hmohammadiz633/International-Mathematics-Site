...
export default function Home() {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-b from-blue-950 via-slate-900 to-blue-950 text-white ${isFa ? 'rtl' : 'ltr'}`} dir={isFa ? 'rtl' : 'ltr'}>
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex flex-wrap justify-between items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-blue-300 font-extrabold">
                {isFa ? 'تدریس تخصصی ریاضیات آزمون‌ها و مقاطع بین‌المللی' : 'Specialized International Math Tutoring'}
              </p>
            </div>
          </div>

          <nav className="hidden md:flex items-center gap-6 text-sm font-extrabold text-blue-100">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white text-xs md:text-sm font-black rounded-xl flex items-center gap-2 transition shadow-md shadow-blue-600/30"
            >
              <span>✈️</span>
            ...
            <button
              ...
              className="px-3.5 py-2 bg-blue-900 hover:bg-blue-800 text-blue-100 text-xs md:text-sm font-black rounded-xl flex items-center gap-1.5 transition border border-blue-700"
            >
              <span>🌐</span>
      ...
      {/* بنر اصلی */}
      <section id="hero" className="py-12 md:py-16 bg-gradient-to-b from-blue-900/40 via-blue-950 to-transparent border-b border-blue-800/50">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <span className="px-4 py-1.5 rounded-full bg-blue-800/50 text-blue-200 border border-blue-600/50 text-xs md:text-sm font-black inline-block mb-4 shadow-sm">
          ...
          <p className="text-blue-100 text-sm md:text-lg max-w-3xl mx-auto leading-relaxed mb-8 font-bold">
            {isFa 
      ...
      <section id="contact" className="py-12 bg-blue-950 border-t border-blue-800">
        <div className="max-w-2xl mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-blue-100 text-sm md:text-base font-bold">
              {isFa
          ...
          <div className="flex flex-col gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-5 bg-blue-900/80 hover:bg-blue-800 border-2 border-blue-700/80 rounded-2xl transition duration-200 flex items-center justify-between shadow-lg group"
            >
              ...
              <span className="text-xs font-black text-sky-300 bg-blue-950 px-3.5 py-2 rounded-xl border border-blue-700">{isFa ? 'ورود ➔' : 'Open ➔'}</span>
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-5 bg-blue-900/80 hover:bg-blue-800 border-2 border-pink-500/40 rounded-2xl transition duration-200 flex items-center justify-between shadow-lg group"
            >
              <div className="flex items-center gap-4">
            ...
            <a
              ...
              className="p-5 bg-blue-900/80 hover:bg-blue-800 border-2 border-red-500/40 rounded-2xl transition duration-200 flex items-center justify-between shadow-lg group"
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-xs text-rose-400 font-mono font-black mt-0.5" dir="ltr">hadi.mohammadi.zarandini@gmail.com</div>
                </div>
              </div>
              <span className="text-xs font-black text-rose-300 bg-blue-950 px-3.5 py-2 rounded-xl border border-red-500/40">{isFa ? 'ایمیل ➔' : 'Send Email ➔'}</span>
            </a>

            <a
              href="tel:+989123104844"
              className="p-5 bg-blue-900/80 hover:bg-blue-800 border-2 border-emerald-500/40 rounded-2xl transition duration-200 flex items-center justify-between shadow-lg group"
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-xs text-emerald-400 font-mono font-black mt-0.5" dir="ltr">+98 912 310 4844</div>
                </div>
              </div>
              <span className="text-xs font-black text-emerald-300 bg-blue-950 px-3.5 py-2 rounded-xl border border-emerald-500/40">{isFa ? 'تماس ➔' : 'Call ➔'}</span>
            </a>
          </div>
        </div>
      </section>
      ...
      {/* فوتر */}
      <footer className="bg-blue-950 border-t border-blue-800 py-6 text-center text-sm font-black text-blue-200">
        <p>
          {isFa
