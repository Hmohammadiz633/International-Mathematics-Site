...
export default function Home() {
  ...
  return (
    <main dir={isFa ? 'rtl' : 'ltr'} className="min-h-screen bg-white text-black font-sans pb-12">
      ...
      {/* بخش کامل درباره من همراه با عکس پرتره */}
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
            ...
            <div className="shrink-0">
              <img
                src="/profile.jpg"
                alt="دکتر هادی محمدی"
                className="w-48 h-60 object-cover rounded-2xl border-2 border-gray-300 shadow-md"
              />
            </div>

            {/* متن درباره من */}
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-4 border-b border-gray-300 pb-3">
