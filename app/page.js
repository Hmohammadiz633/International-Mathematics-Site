...
const MATH_SITES_DATA = [
  ...
  },
  {
    ...
    countryEn: 'USA',
    preUniversity: [
      { nameFa: 'خان آکادمی', nameEn: 'Khan Academy', descFa: 'ریاضی از پایه تا پیشرفته و آمادگی SAT/AP', descEn: 'Math SAT/AP test prep & interactive practice', url: 'https://www.khanacademy.org' },
      { nameFa: 'آی‌اکس‌ال مَث', nameEn: 'IXL Math', descFa: 'تمرین پایه به پایه و استانداردهای آموزشی آمریکا', descEn: 'Comprehensive practice aligned with US standards', url: 'https://www.ixl.com' },
  ...
  return (
    <main dir={isFa ? 'rtl' : 'ltr'} className="min-h-screen bg-slate-50 text-slate-900 font-sans p-4 md:p-8 antialiased">
      <div className="max-w-5xl mx-auto">
        ...
        {selectedCountry && (
          <div className="bg-slate-100 rounded-3xl p-6 md:p-8 border border-slate-300 shadow-sm transition-all duration-300 mb-12">
        ...
        {/* بخش ارتباط با استاد (فقط تلگرام، اینستاگرام و جیمیل با ایمیل مشخص‌شده) */}
        <div className="bg-white rounded-3xl p-6 md:p-8 border border-slate-200 shadow-sm text-center">
          <h3 className="text-lg md:text-xl font-black text-slate-900 mb-6">
            {isFa ? 'ارتباط با استاد' : 'Contact with Professor'}
          </h3>
          <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center gap-2.5 px-5 py-3 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-2xl transition shadow-sm text-slate-800 font-bold text-xs md:text-sm"
            >
            ...
            >
              ...
              <span>Hadi.mohammadi.zarandini</span>
            </a>
