...
export default function Home() {
  ...
  const content = {
    fa: {
      ...
      subtitle: 'ویژه ایرانیان خارج از کشور (آمریکا، کانادا، اروپا، استرالیا و انگلستان)',
  ...
  <div style={{ display: 'flex', flexDirection: 'column', gap: '15px', maxWidth: '450px', margin: '0 auto', direction: 'rtl' }}>
    ...
    {/* تلگرام */}
    <a href="https://t.me/International_Maths" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', flexDirection: 'column', padding: '12px 20px', borderRadius: '12px', textDecoration: 'none', color: '#fff', fontWeight: 'bold', background: 'linear-gradient(135deg, #2AABEE, #229ED9)' }}>
    ...
    {/* اینستاگرام */}
    <a href="https://instagram.com/hadi_mohammadi_zarandini" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', flexDirection: 'column', padding: '12px 20px', borderRadius: '12px', textDecoration: 'none', color: '#fff', fontWeight: 'bold', background: 'linear-gradient(135deg, #833AB4, #FD1D1D, #FCB045)' }}>
    ...
    {/* جیمیل */}
    <a href="mailto:hadi.mohammadi.zarandini@gmail.com" style={{ display: 'flex', flexDirection: 'column', padding: '12px 20px', borderRadius: '12px', textDecoration: 'none', color: '#fff', fontWeight: 'bold', background: 'linear-gradient(135deg, #EA4335, #BB001B)' }}>
