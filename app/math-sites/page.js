...
// کامپوننت داخلی ContactButtons با چیدمان تماماً راست‌چین برای عناوین و توضیحات زیر هم
  ...
  return (
    <section className="max-w-5xl mx-auto px-4 pt-6">
      <div className="bg-white text-gray-900 rounded-3xl p-6 md:p-8 border border-gray-200/90 shadow-md">
        <h4 className="text-xl md:text-2xl font-black text-slate-900 mb-6 flex items-center gap-3 border-b border-gray-100 pb-3 leading-snug text-right">
          ...
          >
            <div className="flex items-center gap-3 w-full">
              ...
              <div className="flex flex-col text-right w-full">
                ...
                <div className="text-xs text-slate-500 text-right mt-0.5">@International_Maths</div>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-3 w-full">
              ...
              <div className="flex flex-col text-right w-full">
                ...
                <div className="text-xs text-slate-500 text-right mt-0.5">@Hadi_mohammadi_zarandini</div>
              </div>
            </div>
            <span className="text-pink-600 font-bold group-hover:translate-x-1 transition-transform shrink-0">↗</span>
          </a>
          ...
          >
            <div className="flex items-center gap-3 w-full overflow-hidden">
              ...
              <div className="flex flex-col text-right w-full overflow-hidden">
                <div className="font-bold text-slate-900 text-sm md:text-base text-right truncate">
                  {isFa ? 'ارسال ایمیل (جیمیل)' : 'Gmail'}
                </div>
                <div className="text-xs text-slate-500 text-right truncate mt-0.5">Hadi.mohammadi.zarandini@gmail.com</div>
              </div>
            </div>
...
export default function Home() {
  ...
  return (
    <main dir={isFa ? 'rtl' : 'ltr'} className="min-h-screen bg-slate-50 text-slate-900 font-sans pb-12 antialiased">
      ...
      <section className="max-w-5xl mx-auto px-4 pt-6">
        <div className="bg-white text-gray-900 rounded-3xl p-6 md:p-8 border border-gray-200/90 shadow-md">
          <h4 className="text-xl md:text-2xl font-black text-slate-900 mb-4 flex items-center gap-3 border-b border-gray-100 pb-3 leading-snug text-right">
            <span className="p-2 bg-blue-50 text-blue-700 rounded-xl">📖</span>
            <span>{isFa ? 'سوابق تدریس' : 'Teaching Experience'}</span>
          </h4>
          <p className="text-slate-700 leading-relaxed text-sm md:text-base font-normal mb-6 text-right">
            {isFa 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-gray-200/80 shadow-sm hover:shadow-md transition">
              ...
              <div className="flex flex-col text-right">
                <h5 className="font-bold text-slate-900 text-sm md:text-base leading-snug text-right">
                  {isFa ? 'دکتری تخصصی ریاضی' : 'Ph.D. in Mathematics'}
                </h5>
                <p className="text-xs text-slate-500 font-normal mt-0.5 text-right">
